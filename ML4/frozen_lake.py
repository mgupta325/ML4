...
def policy_iteration(env, gamma):
    ...
    # plt.plot(i2, t2)
    # plt.xlabel('iterations')
    # plt.title('FL- 4 x 4 grid_Policy_Iteration--> rate of convergence')
...
def value_iteration(env, gamma):
    ...
    # plt.plot(i2, t2)
    # plt.xlabel('iterations')
    # plt.title('FL- 4 x 4 grid_Value_Iteration--rate of convergence graph')
    # plt.ylabel('time taken(in seconds)')
    # plt.show()
    return v, k
...
for i in range(0, 10):
    ...
    if i % 2 != 0:
        plot = plot_policy_map('Frozen Lake Policy Map ' + str(i) + ' (Policy Iteration) ' + 'Gamma: ' + str(gamma),
...
plt.title('FL- 4 x 4 grid_Policy_Iteration--> Time taken vs discount factor')
...
plt.xlabel('discount factor')
plt.title('FL- 4 x 4 grid_Policy_Iteration--> Reward vs discount factor')
plt.ylabel('reward')
plt.show()
...
plt.xlabel('discount factor')
plt.title('FL- 4 x 4 grid_Policy_Iteration-->')
...
plt.plot(discount, t)
plt.xlabel('discount factor')
plt.title('FL- 4 x 4 grid_Value_Iteration--> Time taken vs discount factor')
plt.ylabel('Time (in seconds)')
plt.show()
...
plt.plot(discount, score)
plt.xlabel('discount factor')
plt.title('FL- 4 x 4 grid_Value_Iteration--> Reward vs discount factor')
plt.ylabel('reward')
plt.show()
...
plt.plot(discount, iter)
plt.xlabel('discount factor')
plt.title('FL- 4 x 4 grid_Value_Iteration')
plt.ylabel('Iterations')
plt.show()
